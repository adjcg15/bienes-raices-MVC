...
<fieldset>
    ...
    <input type="number" id="estacionamiento" name="propiedad[estacionamiento]" placeholder="Número de baños" min="1" max="9" value="<?php echo s($propiedad->estacionamiento); ?>">
</fieldset>
